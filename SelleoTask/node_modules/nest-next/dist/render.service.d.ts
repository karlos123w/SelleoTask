...
export declare class RenderService {
    ...
    isDev(): boolean;
    passthroughNotFoundErrors(): boolean;
    ...
    initializeDynamicRouteRegexes(routes?: string[]): void;
    isInitialized(): boolean;
    bindHttpServer(server: HttpServer): void;
    getNormalizedPath(view: string): string;
    protected getViewPath(view: string, params: ParsedUrlQuery): string;
}
